...
const AlbumCard: React.FC<AlbumCardProps> = ({ album, data }) => {
    const [open, setOpen] = useState<boolean>(false);

    return (
        <div className="post postContainer__sb bg-slate-700" >
            <div className="article">
                <div className="w-full flex flex-row items-center justify-start text-white gap-1">
                    <div className="w-full h-[50px] flex flex-row justify-between items-center mb-2">
                        ...
                        >
                            ...
                            <div>
                                {Array.isArray(data.users)
                                    ? data.users
                                        .filter((user) => user.id === album.userId)
                        ...
                        >
                            <Link className="" to={`/Album/${album.id}/Edit`}>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    fill="currentColor"
